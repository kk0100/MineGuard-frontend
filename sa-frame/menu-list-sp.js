...
window.menuList.unshift(
	{
		...
		info: '对系统的各种消息进行管理',
		url: 'sa-view-sp/sp-information/information-list.html',
	},
	// {
	// 	id: 'bas',
	// 	name: '身份相关',
	...
	// },
	{
		...
		info: '对系统的用户进行管理',
		childList: [
			{id: 'user-list', name: '用户列表', url: 'sa-view-sp/sp-user/user-list.html', info: '所有用户列表'},
			{id: 'user-add', name: '用户添加', url: 'sa-view-sp/sp-user/user-add.html', info: '添加一个用户'},
			{id: 'sp-user-login', name: '登录日志', url: 'sa-view-sp/sp-user-login/sp-user-login-list.html', info: '查看用户历史登录信息'
			}]
	},
	{	
		id: 'auth',
