...
(function(){
	...
	// 正式生产环境
	var cfg_prod = {
		api_url: 'http://1.14.239.100:8099',
		web_url: 'http://1.14.239.100'
	}
...
(function(){
	...
	sa.ajax = function(url, data, success200, cfg){
		...
		return $.ajax({
			...
			data: data,
			dataType: 'json',
			contentType: (cfg.contentType ? cfg.contentType : 'application/x-www-form-urlencoded; charset=UTF-8'),
			// xhrFields: {
